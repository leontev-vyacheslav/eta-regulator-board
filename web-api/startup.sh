...
gunicorn --workers=1 --threads=6 --timeout=120 --pid=PID_FILE --bind=0.0.0.0:5000 --chdir=./src --env REGULATION_ENGINE_LOG_TO_FILE=1 --env APP_LOG_TO_FILE=1 --env REGULATION_ENGINE_LIFETIME=1800 app:app