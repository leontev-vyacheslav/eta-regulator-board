...
def get_heating_circuit_settings(heating_circuit_index: HeatingCircuitTypeModel) -> HeatingCircuitModel:
...
def polling(heating_circuit_index: HeatingCircuitModel):
...
def start_regulation_engine(heating_circuit_index: HeatingCircuitModel):
    # start polling temperature sensors and calculation
    polling_thread = Thread(target=polling, args=(heating_circuit_index, ))
